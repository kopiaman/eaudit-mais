...
require_once("include/reference_variables.php");
...
$page_layouts["reference_detailspreview"] = $layout;
...
$xt->load_template(GetTemplateName("reference", "detailspreview"));
