...
<div class="table-responsive">
                ...
                <tbody >
                    ...
                    <tr >
                        ...
                        <a href="../website/viewSusulanCombine.php?aYear=<?php echo date('Y') ?>" target="_blank"><?php echo $query['red']; ?> </a></div></td>
                    ...
                    <tr >
                       ...
                       <a href="../website/viewSusulanCombine.php?aYear=<?php echo date('Y') ?>" target="_blank"><?php echo $query['yellow']; ?> </a></div></td>
                    ...
                    <tr >
                        ...
                        <td style="background-color:black"><div class="icon" style="background-color:green; color:white"> 
						 <a href="../website/viewSusulanCombine.php?aYear=<?php echo date('Y') ?>" target="_blank"><?php echo $query['green']; ?> </a></div></td>
