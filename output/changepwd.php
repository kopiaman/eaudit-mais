...
$layout = new TLayout("changepwd2", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
{	
	...
	{
		$values["oldpass"] = md5($values["oldpass"]);
	}
...
$layout = new TLayout("changepwd_success2", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["changepwd"] = array();
$layout->container_properties["changepwd"] = array(  );
