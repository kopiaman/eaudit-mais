...
$nonAdminTablesArr[] = "audit_form";
$nonAdminTablesArr[] = "audit_info";
$nonAdminTablesArr[] = "set_cat";
$nonAdminTablesArr[] = "set_field";
$nonAdminTablesArr[] = "set_audit_element";
$nonAdminTablesArr[] = "auditee";
$nonAdminTablesArr[] = "set_mais_orga";
$nonAdminTablesArr[] = "audit_plan";
$nonAdminTablesArr[] = "all";
$nonAdminTablesArr[] = "web_file";
$nonAdminTablesArr[] = "main";
$nonAdminTablesArr[] = "jumlah_audit_bahagian";
$nonAdminTablesArr[] = "reference_detail";
$nonAdminTablesArr[] = "finding";
$nonAdminTablesArr[] = "web_news";
$nonAdminTablesArr[] = "report_SKT";
$nonAdminTablesArr[] = "report_susulan";
$nonAdminTablesArr[] = "web_annoucement";
$nonAdminTablesArr[] = "web_slider";
$nonAdminTablesArr[] = "web_meeting";
$nonAdminTablesArr[] = "set_audit_subType";
$nonAdminTablesArr[] = "set_audit_type";
$nonAdminTablesArr[] = "audit_form_manual";
...
$wGroupTableName = $ug_connection->addTableWrappers( "user_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "user_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "user_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "user_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "user_ugmembers" );
