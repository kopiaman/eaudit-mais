...
class AuditTrailTable
{
	...
	function logValueEnable($table)
	{
		...
		if($table=="jumlah_audit_bahagian")
		{
			return false;
		}
		if($table=="reference_detail")
		{
			return false;
		}
		if($table=="finding")
		...
		if($table=="report_susulan")
		{
			return false;
		}
		if($table=="web_annoucement")
		{
			return false;
		}
		if($table=="web_slider")
		...
		if($table=="web_meeting")
		{
			return false;
		}
		if($table=="set_audit_subType")
		{
			return true;
		}
		if($table=="set_audit_type")
		{
			return true;
		}
		if($table=="audit_form_manual")
		{
			return true;
		}
	}
