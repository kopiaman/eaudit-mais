...
class ConnectionManager
{
	...
	{
		return $this->byId( "eaudit_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "eaudit_at_localhost";
		...
		$this->_connectionsIdByName["eaudit at localhost"] = "eaudit_at_localhost";
...
;
		$connectionsData["eaudit_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["auditee_reply"] = "eaudit_at_localhost";
		$connectionsIds["auditee_reply2"] = "eaudit_at_localhost";
		$connectionsIds["auditee_reply3"] = "eaudit_at_localhost";
		$connectionsIds["thankyou"] = "eaudit_at_localhost";
