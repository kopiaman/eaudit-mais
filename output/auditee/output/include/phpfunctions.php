...
function fileCustomExpression($file, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="auditee_reply" && $field=="reply_attachment")
	{
		;
		return $value;
	}	
				if($table=="auditee_reply2" && $field=="reply_attachment")
	{
		;
		return $value;
	}	
				if($table=="auditee_reply2" && $field=="reply_attachment2")
	{
		;
		return $value;
	}	
				if($table=="auditee_reply3" && $field=="reply_attachment")
	{
		;
		return $value;
	}	
				if($table=="auditee_reply3" && $field=="reply_attachment2")
	{
		;
		return $value;
	}	
				if($table=="auditee_reply3" && $field=="reply_attachment3")
	{
		;
		return $value;
	}	
