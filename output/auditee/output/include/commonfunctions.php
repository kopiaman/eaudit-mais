...
function checkTableName($shortTName, $type=false)
{
	...
	if ("auditee_reply" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("auditee_reply2" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("auditee_reply3" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("thankyou" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	return false;
}
...
function GetUserPermissions($table="")
{
	...
	if(!$table)
		$table = $strTableName;
	$permissions = "";
	if($table=="auditee_reply")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="auditee_reply2")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="auditee_reply3")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="thankyou")
