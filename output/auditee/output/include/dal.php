...
class tDAL
{
	var $tbleaudit_at_localhost__audit_info;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "audit_info", "varname" => "eaudit_at_localhost__audit_info", "altvarname" => "audit_info", "connId" => "eaudit_at_localhost", "schema" => "", "connName" => "eaudit at localhost");
	}
