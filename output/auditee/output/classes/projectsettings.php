...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("auditee_reply" == $table) 
		return "auditee_reply";
	if("auditee_reply2" == $table) 
		return "auditee_reply2";
	if("auditee_reply3" == $table) 
		return "auditee_reply3";
	if("thankyou" == $table) 
		return "thankyou";
...
{	
	...
	if(!$shortTName)
		return false;
	if("auditee_reply" == $shortTName) 
		return "auditee_reply";
	if("auditee_reply2" == $shortTName) 
		return "auditee_reply2";
	if("auditee_reply3" == $shortTName) 
		return "auditee_reply3";
	if("thankyou" == $shortTName) 
		return "thankyou";
}
