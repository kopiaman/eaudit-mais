...
class AddPage extends RunnerPage
{
	...
	protected function setSuccessfulUpdateMessage()
	{
		...
		if( $this->mode == ADD_INLINE ) 
			$infoMessage = ""."Rekod telah ditambah"."";
		else
			$infoMessage = "<<< "."Rekod telah ditambah"." >>>";
		...
		if( $this->editAvailable() )
			$infoMessage.= "&nbsp;<a href='".GetTableLink( $this->pSet->getShortTableName(), "edit", $keylink )."'>"."Sunting"."</a>&nbsp;";
	...
	public function setDatabaseError( $message )
	{
		if( $this->mode != ADD_INLINE )
		{
			$this->message = "&lt;&lt;&lt; "."Rekod TIDAK tertambah"." &gt;&gt;&gt;<br><br>".$message;
		}
		else
		{
			$this->message = "Rekod TIDAK tertambah".". ".$message;
		}
