...
function GetTableURL($table = "")
{
	...
	if("set_field" == $table)
		return "set_field";
	if("set_audit_element" == $table)
		return "set_audit_element";
	...
	if("auditee" == $table)
		return "auditee";
	if("set_mais_orga" == $table)
		return "set_mais_orga";
	if("audit_plan" == $table)
		return "audit_plan";
	if("all" == $table)
		return "all";
	...
	if("main" == $table)
		return "main";
	if("jumlah_audit_bahagian" == $table)
		return "jumlah_audit_bahagian";
	if("reference_detail" == $table)
	...
	if("report_SKT" == $table)
		return "report_SKT";
	if("report_susulan" == $table)
		return "report_susulan";
	if("web_annoucement" == $table)
		return "web_annoucement";
	if("web_slider" == $table)
		return "web_slider";
	if("web_meeting" == $table)
		return "web_meeting";
	if("set_audit_subType" == $table)
		return "set_audit_subType";
	if("set_audit_type" == $table)
		return "set_audit_type";
	if("audit_form_manual" == $table)
		return "audit_form_manual";
...
function GetTableByShort($shortTName = "")
{
	...
	if("user" == $shortTName)
		return "user";
	if("audit_form" == $shortTName)
		return "audit_form";
	if("audit_info" == $shortTName)
		return "audit_info";
	if("set_cat" == $shortTName)
		return "set_cat";
	if("set_field" == $shortTName)
		return "set_field";
	if("set_audit_element" == $shortTName)
		return "set_audit_element";
	...
	if("admin_users" == $shortTName)
		return "admin_users";
	if("auditee" == $shortTName)
		return "auditee";
	if("set_mais_orga" == $shortTName)
		return "set_mais_orga";
	if("audit_plan" == $shortTName)
		return "audit_plan";
	if("all" == $shortTName)
		return "all";
	if("web_file" == $shortTName)
		return "web_file";
	if("main" == $shortTName)
		return "main";
	if("jumlah_audit_bahagian" == $shortTName)
		return "jumlah_audit_bahagian";
	if("reference_detail" == $shortTName)
		return "reference_detail";
	if("finding" == $shortTName)
		return "finding";
	if("web_news" == $shortTName)
		return "web_news";
	if("report_SKT" == $shortTName)
		return "report_SKT";
	if("report_susulan" == $shortTName)
		return "report_susulan";
	if("web_annoucement" == $shortTName)
		return "web_annoucement";
	if("web_slider" == $shortTName)
		return "web_slider";
	if("web_meeting" == $shortTName)
		return "web_meeting";
	if("set_audit_subType" == $shortTName)
		return "set_audit_subType";
	if("set_audit_type" == $shortTName)
		return "set_audit_type";
	if("audit_form_manual" == $shortTName)
		return "audit_form_manual";
}
