...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("audit_form" == $this->chrt_array['tables'][0])
			return true;
		if("audit_info" == $this->chrt_array['tables'][0])
			return true;
		if("set_cat" == $this->chrt_array['tables'][0])
			return true;
		if("set_field" == $this->chrt_array['tables'][0])
			return true;
		if("set_audit_element" == $this->chrt_array['tables'][0])
			return true;
		if("user_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("auditee" == $this->chrt_array['tables'][0])
			return true;
		if("set_mais_orga" == $this->chrt_array['tables'][0])
			return true;
		if("audit_plan" == $this->chrt_array['tables'][0])
			return true;
		if("audit_form" == $this->chrt_array['tables'][0])
			return true;
		if("web_file" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("audit_form" == $this->chrt_array['tables'][0])
			return true;
		if("reference_detail" == $this->chrt_array['tables'][0])
			return true;
		if("finding" == $this->chrt_array['tables'][0])
			return true;
		if("web_news" == $this->chrt_array['tables'][0])
			return true;
		if("audit_plan" == $this->chrt_array['tables'][0])
			return true;
		if("audit_form" == $this->chrt_array['tables'][0])
		...
		if("web_file" == $this->chrt_array['tables'][0])
			return true;
		if("set_audit_subType" == $this->chrt_array['tables'][0])
			return true;
		if("set_audit_type" == $this->chrt_array['tables'][0])
			return true;
		if("audit_form" == $this->chrt_array['tables'][0])
			return true;
		return false;
