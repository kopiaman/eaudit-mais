...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("user" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_form" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_info" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_cat" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_field" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_audit_element" == $this->xml_array['tables'][0])
			$isDB = true;
		if("user_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("user" == $this->xml_array['tables'][0])
			$isDB = true;
		if("user" == $this->xml_array['tables'][0])
			$isDB = true;
		if("auditee" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_mais_orga" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_plan" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_form" == $this->xml_array['tables'][0])
			$isDB = true;
		if("web_file" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_form" == $this->xml_array['tables'][0])
			$isDB = true;
		if("reference_detail" == $this->xml_array['tables'][0])
			$isDB = true;
		if("finding" == $this->xml_array['tables'][0])
			$isDB = true;
		if("web_news" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_plan" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_form" == $this->xml_array['tables'][0])
		...
		if("web_file" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_audit_subType" == $this->xml_array['tables'][0])
			$isDB = true;
		if("set_audit_type" == $this->xml_array['tables'][0])
			$isDB = true;
		if("audit_form" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
