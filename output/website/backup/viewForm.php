...
LEFT JOIN set_audit_type ON audit_form.elementID = set_audit_type.aSubNo
  ...
  <div class="container">
    ...
    <table width="1050" border="1" cellpadding="10" cellspacing="0" class="plainTable">
      ...
      <tr>
        ...
        <td valign="top"><?php echo $detail['finding']; ?><br><a href="../output/<?php echo full($detail['attachment']); ?>" target="_blank"> ATTACHMENT</a></td>
        <td valign="top"><?php echo $detail['rujukan']; ?></td>
        <td valign="top"><?php echo $detail['suggest']; ?></td>
        <td valign="top"><span class="col-sm-4">
          
            <?php 
		if ($detail['answer']){ echo 'Maklum Balas 1: '.$detail['answer'].'<br/>';?>
            <a href="<?php echo '../'.full($detail['reply_attachment']) ?>" target="_blank">ATTACHMENT</a>
            <?php }; ?>
            
            <?php 
		if ($detail['answer2']){ echo '<br/><br/>Maklum Balas 2: '.$detail['answer2'].'<br/>';?>
            <a href="<?php echo '../'.full($detail['reply_attachment2']) ?>" target="_blank">ATTACHMENT</a>
          <?php }; ?>
     
          <?php 
		if ($detail['answer3']){ echo '<br/><br/>Maklum Balas 3: '.$detail['answer3'].'<br/>';?>
          <a href="<?php echo '../'.full($detail['reply_attachment3']) ?>" target="_blank">ATTACHMENT</a>
          <?php }; ?>
