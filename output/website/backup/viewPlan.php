...
WHERE audit_plan.aYear=$aYear AND audit_plan.`organization`='$orga'
GROUP BY aType
";
    ...
    <table width="100%" border="0" cellpadding="0">
      <tr>
        <td  align="center" valign="top"><h1><span class="text-center">
          SASARAN KERJA TAHUNAN <?php echo $aYear ?></span>   </h1>
           <h2><?php echo $orga ?></h2>
     ...
     <?php
	 do{ ?>
    <br/><br/><h2><?php echo'AUDITAN '. $aType=$planType['aType'];?></h2>
    
    <table width="1160" border="1" cellpadding="10" cellspacing="0" class="plainTable">
      <tr>
...
FROM audit_plan
LEFT JOIN audit_form ON audit_plan.planID = audit_form.planID
WHERE audit_plan.aYear=$aYear AND audit_plan.`organization`='$orga' AND audit_plan.aType='$aType'
