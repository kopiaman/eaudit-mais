...
require_once("include/set_audit_aType_element_variables.php");
...
$layout = new TLayout("search2", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["set_audit_aType_element_search"] = $layout;
...
$params['shortTableName'] = 'set_audit_aType_element';
