...
$layout = new TLayout("export2", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["set_audit_type_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["aTypeID"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
