...
require_once("include/audit_plan_report_variables.php");
...
$layout = new TLayout("search2", "Coral1Coral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["audit_plan_report_search"] = $layout;
...
$params['shortTableName'] = 'audit_plan_report';
