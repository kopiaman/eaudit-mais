...
require_once("include/audit_plan_variables.php");
...
$layout = new TLayout("edit_under_center", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$layout->containers["edit"][] = array("name"=>"multistep_nav_edit", 
	"block"=>"", "substyle"=>1  );
...
$layout->containers["fields"][] = array("name"=>"editfields_atop", 
	"block"=>"", "substyle"=>1  );
...
$page_layouts["audit_plan_edit"] = $layout;
...
$layout = new TLayout("tab", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["audit_plan_edit_Step1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["audit_plan_edit_Step2"] = $layout;
