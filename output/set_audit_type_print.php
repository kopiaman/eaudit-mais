...
$layout = new TLayout("print", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["set_audit_type_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "set_audit_type" );
