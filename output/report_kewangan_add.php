...
require_once("include/report_kewangan_variables.php");
...
$layout = new TLayout("add_under_center", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$layout->containers["add"][] = array("name"=>"multistep_nav_add", 
	"block"=>"", "substyle"=>1  );
...
$layout->containers["fields"][] = array("name"=>"addfields_atop", 
	"block"=>"", "substyle"=>1  );
...
$page_layouts["report_kewangan_add"] = $layout;
...
$page_layouts["report_kewangan_add_Step1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["report_kewangan_add_Step31"] = $layout;
