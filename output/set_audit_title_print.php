...
$layout = new TLayout("print", "Coral1Coral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["set_audit_title_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "set_audit_title" );
